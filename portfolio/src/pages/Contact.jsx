  ...
  return (
    <div className="min-h-screen bg-[#6cf56c] text-black font-sans selection:bg-black selection:text-[#ffff4d] pb-20">
      ...
      <nav className="fixed top-0 left-0 w-full z-50 px-6 py-6 md:px-10 md:py-8 flex items-center justify-between pointer-events-none">
        ...
        {/* LEFT GROUP (Clickable) */}
        <div className="flex items-center gap-4 pointer-events-auto">
          <Link to="/" className="group">
            <button className="bg-black text-[#ffff4d] border-2 border-black px-4 py-2 md:px-6 md:py-2 font-mono font-bold uppercase tracking-widest hard-shadow hover:bg-white hover:text-black transition-all text-xs md:text-sm">
              ← Back Home
            </button>
          </Link>
          <span className="font-['Palette_Mosaic'] text-xl md:text-2xl uppercase tracking-widest hidden md:block mix-blend-hard-light">
            Contact_V1.0
          </span>
        </div>
